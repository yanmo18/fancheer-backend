...
export const createActivity = async (req: Request, res: Response) => {
  ...
  const result = await activitiesService.createActivity({ title, description, coverUrl, startTime, endTime, sortOrder })
...
export const updateActivity = async (req: Request, res: Response) => {
  ...
  await activitiesService.updateActivity(Number(id), { title, description, coverUrl, startTime, endTime, sortOrder })
