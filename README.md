...
| 角色 | 说明 | 权限范围 |
|------|------|----------|
| 游客 | 未登录用户 | 浏览首页内容（Banner、主播资料、获奖、图集、活动、音乐、关系图谱） |
| fan | 注册粉丝 | 首页浏览 + 个人中心 + 聊天室 + 每日打卡 |
| admin | 管理员 | 粉丝权限 + 管理后台 + 上传，**不可查看私密消息** |
| streamer | 主播 | 管理员权限 + 查看/回复私密消息 + **设置/取消管理员** |
